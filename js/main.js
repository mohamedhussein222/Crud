...
submit.onclick = function(){
  ...
  if(title.value != '' && price.value != '' && category.value !='' && count.value > 0 && count.value < 100){
if(mood === 'create'){
  if(newPro.count > 1){
...
function searchData(value){
  ...
  for(let i=0; i < dataPro.length; i++){
  if (searchmood == 'title'){
    if(dataPro[i].title.includes(value.toLowerCase())){table += `
    <tr>
                <td>${i}</td>
                <td>${dataPro[i].title}</td>
                <td>${dataPro[i].price}</td>
    ...
    `;}}
  else{ if(dataPro[i].category.includes(value.toLowerCase())){table += `
  <tr>
              <td>${i}</td>
              <td>${dataPro[i].title}</td>
              <td>${dataPro[i].price}</td>
